...
def create_crawerlist(Name, Page, crawler_list):
        url = 'https://www.google.com.hk/search?q=' + Name + '+professional+profile+linkedin&dcr=0&ei=yjnXWeGUKYK98QXPmb7oBw&start=' + str(Page) + '&sa=N&biw=1440&bih=826'
...
if __name__ == '__main__':
   company_name = ['Alibaba','The Boston Consaulting Group','GoldmanSachs']
